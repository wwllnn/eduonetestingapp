...
export const SAT2023PT3RWM2AQ = {
  ...
  34: {
    ...
    choice1: 'To express hope that a child will have the same accomplishments as his parent did',
    choice2: 'To suggest that raising a child involves many struggles',
    choice3: 'To warn a child that he will face many challenges throughout his life',
    choice4: 'To encourage a child to embrace the experiences life will offer',
    answer: 'D'
  },
  35: {
    ...
    question: 'Which choice best states the main purpose of the text?',
    choice1: 'To discuss von Ahn’s invention of reCAPTCHA',
    choice2: 'To explain how digital scanners work',
    choice3: 'To call attention to von Ahn’s book-digitizing project',
    choice4: 'To indicate how popular reCAPTCHA is',
    answer: 'A'
  },
  36: {
    passage: `Text 1
...
Text 2
  ...
  Paleontologists were excited to discover a second small fossil that is similar to the strange O. khaungraae fossil but has part of the lower body along with a birdlike skull. Detailed studies of both fossils revealed several traits that are found in lizards but not in dinosaurs or birds. Therefore, paleontologists think the two creatures were probably unusual lizards, even though the skulls looked avian at first.`,
    ...
    choice3: 'It is flawed because the researchers mistakenly assumed that O. khaungraae must be a lizard.',
    choice4: 'It is reasonable because the O. khaungraae skull is about the same size as the skull of the second fossil but is shaped differently.',
    answer: 'A'
  },
  37: {
    ...
    choice1: 'It becomes increasingly vigorous with the passage of time.',
    choice2: 'It draws strength from changes in the weather.',
    choice3: 'It requires proper nourishment in order to thrive.',
    choice4: 'It perseveres despite challenging circumstances.',
    answer: 'C'
  },
  38: {
    img: 'satpt3rwa38.png',
  ...
  43: {
    ...
    choice1: 'Anishinaabe adults who didn’t attend the school feel roughly the same degree of cultural pride as the former students of the school feel.',
    choice2: 'After transferring to the school, new students experience an increase in both fluency and academic performance overall.',
    choice3: 'As adults, former students of the school are just as likely to continue living in their community as individuals who didn’t attend the school.',
    choice4: 'As they complete secondary and higher education, former students of the school experience no loss of fluency or cultural pride.',
    answer: 'D'
  },
  44: {
  ...
  This technique is minimally invasive.`,
    ...
    choice3: 'Park rangers can use a power grinding technique to smooth away carvings or fill them in with ground sandstone and a bonding agent.',
    choice4: 'As methods for removing carvings from sandstone, power grinding and infilling differ in their level of invasiveness.',
    answer: 'B'
  },
  54: {
    passage: `While researching a topic, a student has taken the following notes:
  ...
  When light passed through the fence, colorful prisms formed.`,
    ...
    choice3: 'The chain-link fence in Soo Sunny Park’s Unwoven Light was fitted with tiles made from iridescent plexiglass.',
    choice4: 'In Unwoven Light, a 2013 work by Korean American artist Soo Sunny Park, light formed colorful prisms as it passed through a fence Park had fitted with iridescent tiles.',
    answer: 'D'
  }
}
...
export const SAT2023PT3RWM2BQ = {
  ...
  30: {
    ...
    choice3: 'overshadowed by', 
    choice4: 'irrelevant to ',
    answer: 'C'
  },
  31: {
...
Text 2
  ...
  37: {
    ...
    choice2: 'the highest number of tools were at a depth of 3–4 meters below the surface, which suggests that the Neanderthal population at the site was highest during the related period of time.',
    choice3: 'at each depth below the surface in the cave, the difference in the numbers of tools of each type suggests that Neanderthals preferred to use clamshells from the beach because of their durability.',
    choice4: 'the higher number of tools at depths of 5–6 meters below the surface in the cave than at depths of 4–5 meters below the surface suggests that the size of clam populations changed over time.',
    answer: 'A'
  },
  38: {
